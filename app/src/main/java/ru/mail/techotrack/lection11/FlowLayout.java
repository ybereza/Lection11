...
public class FlowLayout extends ViewGroup {
    ...
    private int _gravity = Gravity.CENTER_HORIZONTAL | Gravity.TOP;
    private List<Integer> _widthList = new ArrayList<Integer>();
        ...
        */
        ...
        for (int i = 0; i < childCount; ++i) {
            ...
            if (i == 0 || (lineWidth + childWidth) > widthSize) {  // Новая линия
                lineWidth = childWidth;
                currentLineWidth = _widthList.get(lineCnt);
                ++lineCnt;
