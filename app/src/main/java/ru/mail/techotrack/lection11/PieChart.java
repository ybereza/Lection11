...
public class PieChart extends ViewGroup {
     ...
     *                {@link ru.mail.techotrack.lection11.R.styleable.PieChart} as well as attributes inherited
     ...
     * the control.
     *
     * @param showTextPie true if the text label should be visible, false otherwise
     */
    public void setShowTextPie(boolean showTextPie) {
        mShowText = showTextPie;
        invalidate();
    }
